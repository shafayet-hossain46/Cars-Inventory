...
const ManageInventoryItem = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://nameless-shore-79198.herokuapp.com/manageInventoryItem/${id}`
      )
      .then((res) => {
  ...
  const handleDeliveredButton = (id) => {
    axios
      .put(`https://nameless-shore-79198.herokuapp.com/delivered/${id}`)
      .then((res) => {
  ...
  const handleAddQuantity = (e) => {
    ...
    axios
      .put(
        `https://nameless-shore-79198.herokuapp.com/updateQuantity/${id}`,
        newExtraQuantity
      )
      .then((res) => {
        if (res.data.modifiedCount >= 0) {
    ...
    <Container>
      <Row xs={1} md={2} className="mt-4">
          ...
          >
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                <br />
                <span style={{ color: "#34e7e4", fontWeight: "bold" }}>☐ </span>
                {item?.description}
              </Card.Text>
            </Card.Body>
            ...
            <div className="d-grid gap-2">
              <Button
                onClick={() => handleDeliveredButton(item?._id)}
        ...
        <Col>
          ...
          >
            <Card.Body>
              <Card.Title className="text-center" style={{ color: "#2C3A47" }}>
                Restock The Item
              </Card.Title>
              <Card.Text>
                <form onSubmit={handleAddQuantity}>
                  <input
                    ...
                    type="number"
                    placeholder="Put The Quantity You Want To Add..."
                    name="number"
                    required
                  />
                  <div className="d-grid gap-2">
                    <input
                      className="text-white form-control bg-info"
                      size="lg"
                      type="submit"
                      value="Restock"
                    />
